    ...
    def __init__(self,
        ...
        if path_imgrec:
            ...
            if header.flag > 0:
                ...
                self.header0 = (int(header.label[0]), int(header.label[1]))  # (3804847, 3890011)

                # assert(header.flag==1)
                self.imgidx = list(range(1, int(header.label[0])))  # 3804847
                self.id2range = {}
        ...
        print('provide_label:',self.provide_label[0])
        self.cur = 0
        self.nbatch = 0
        self.is_init = False
    ...
    def next(self):
        ...
        try:
            while i < batch_size:
                ...
                data = [_data]
                data[0] = self.brightness_aug(data[0].astype('float32'),0.3)
                try:
...
#         batch_size=400,
#         data_shape=(3,112,112),  # (3L,112L,112L)
#         path_imgrec='../dataset/faces_vgg_112x112/train.rec',  # train.rec
#         shuffle=True,
#         rand_mirror=1,  # 1
#         mean=None,
#         cutoff=0,  # 0
#     )
#     for i in train_dataiter:
#         print('....')